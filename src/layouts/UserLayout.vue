  ...
  <div id="userLayout" :class="['user-layout-wrapper', device]">
    <div class="container">
      ...
      <div class="footer">
        ...
        <div class="copyright">
          Copyright © 2028 <a target="_blank" :href=compweburl>{{compname}}</a> All rights reserved. v1.3.2
        </div>
      </div>
    </div>
  </div>
...
import { domAppName,domCompName,domCompWebUrl } from '@/utils/domUtil'
...
export default {
  ...
  created () {
    this.appname=domAppName
    this.compname=domCompName
    this.compweburl=domCompWebUrl
  },
  mounted () {
