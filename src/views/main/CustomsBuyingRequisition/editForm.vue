          ...
          this.form.setFieldsValue(
            {
              ...
              buyingType: record.buyingType.toString(),
              buyingMethods: JSON.parse(record.buyingMethods),
      ...
      handleSubmit () {
        ...
        validateFields((errors, values) => {
          if (!errors) {
            ...
            CustomsBuyingRequisitionEdit(values).then((res) => {
              if (res.success) {
