    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="科研系统同步标记" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-select style="width: 100%" placeholder="请选择科研系统同步标记" v-decorator="['syncflg_keyan', {rules: [{ required: true, message: '请选择！' }]}]" >
        ...
        <a-form-item label="财务系统同步标记" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-select style="width: 100%" placeholder="请选择财务系统同步标记" v-decorator="['syncflg_caiwu', {rules: [{ required: true, message: '请选择！' }]}]" >
        ...
        <a-form-item label="状态" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-select style="width: 100%" placeholder="请选择状态" v-decorator="['workflg', {rules: [{ required: true, message: '请选择！' }]}]" >
        ...
        <a-form-item label="流程状态" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-select style="width: 100%" placeholder="请选择流程状态" v-decorator="['stageflg'], {rules: [{ required: true, message: '请选择！' }]}" >
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      add (record) {
        this.visible = true
        const DicOptions = this.$options
        this.syncflg_keyanData = DicOptions.filters['dictData']('yes_or_no')
        this.syncflg_caiwuData = DicOptions.filters['dictData']('yes_or_no')
        this.workflgData = DicOptions.filters['dictData']('vis_type')
        this.stageflgData = DicOptions.filters['dictData']('vis_type')
      },
      /**
       * 提交表单
       */
