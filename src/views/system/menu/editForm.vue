<template>
  <a-modal title="编辑菜单" :width="1000" :visible="visible" :confirmLoading="confirmLoading" @ok="handleSubmit"
        ...
        <a-row :gutter="24">
          <a-col :md="12" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="所属应用" has-feedback>
              <a-select style="width: 100%" :disabled="appDisabled" placeholder="请选择应用分类"
            ...
            <div v-show="pidShow">
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="父级菜单" has-feedback>
                <a-tree-select v-decorator="['pid', { rules: [{ required: true, message: '请选择父级菜单！' }] }]"
                  ...
                  placeholder="请选择父级菜单" treeDefaultExpandAll @change="setPid">
          ...
          <a-col :md="12" :sm="24">
            <div v-show="componentShow">
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" hasFeedback>
                ...
                <a-input placeholder="请输入前端组件" :disabled="componentDisabled" prop="component"
        ...
        <a-row :gutter="24">
          ...
          <a-col :md="12" :sm="24">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="是否可见">
              <a-switch id="visible" checkedChildren="是" unCheckedChildren="否"
        ...
        <a-row>
          <a-col :md="12">
            <div v-show="keepAliveShow">
              <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol">
                <span slot="label" style="width: 100px;">
                  <a-tooltip title="多标签模式下，默认缓存所有页面">
                    <a-icon type="question-circle-o" />
                  </a-tooltip>&nbsp;
                  是否缓存
                </span>
                <a-switch id="keepAlive" checkedChildren="是" unCheckedChildren="否"
                  v-decorator="['keepAlive', { valuePropName: 'checked' }]" />
              </a-form-item>
            </div>
...
export default {
  ...
  methods: {
    ...
    edit(record) {
      ...
      this.form.getFieldDecorator('keepAlive', { valuePropName: 'checked', initialValue: record.keepAlive })
