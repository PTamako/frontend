<template>
  <div>
    ...
    <a-card :bordered="false">
      ...
      >
        <template slot="operator" v-if="hasPerm('sysArticle:add')">
          <a-button @click="$refs.addForm.add()" icon="plus" type="primary" v-if="hasPerm('sysArticle:add')" >新增文章</a-button>
        </template>
        ...
        <span slot="action" slot-scope="text, record">
          <div>
            ...
            <a-divider type="vertical" v-if="hasPerm('sysArticle:detail') & hasPerm('sysArticle:delete')"/>
      ...
      <add-form ref="addForm" @ok="handleOk" v-if="hasPerm('sysArticle:add')"/>
      <edit-form ref="editForm" @ok="handleOk" v-if="hasPerm('sysArticle:edit')"/>
      <detail-form ref="detailForm" @ok="handleOk" v-if="hasPerm('sysArticle:detail')"/>
      <div ref="editor"></div>
    </a-card>
  </div>
</template>
