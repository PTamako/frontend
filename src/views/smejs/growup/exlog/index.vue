      ...
      <div slot="content" class="table-page-search-wrapper">
        <a-form layout="inline">
          <a-row :gutter="48">
            ...
            <a-col :md="4" :sm="24">
              <a-form-item label="方法名1">
                <a-input v-model="queryParam.methodName" allow-clear placeholder="请输入方法名1" />
              </a-form-item>
            </a-col>
            <a-col :md="4" :sm="24">
              <a-form-item label="方法名2">
                <a-input v-model="queryParam.methodName" allow-clear placeholder="请输入方法名2" />
              </a-form-item>
            </a-col>
